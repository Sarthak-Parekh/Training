...
<body>
        ...
        <div class="page-wrapper">
            ...
            <div class="top-links">
                <div class="container">
                    <ul class="row links">
                        ...
                        <li class="col-xs-12 col-sm-4 link-item"><span>1</span><a href="store.php">Choose Store</a></li>
                        <li class="col-xs-12 col-sm-4 link-item active"><span>2</span><a href="item.php?s_id=<?php echo $_GET['s_id']; ?>">Pick Your favorite food</a></li>
			...
			<?php $ress= mysqli_query($db,"select * from store where s_id='$_GET[s_id]'");
									     $rows=mysqli_fetch_array($ress);
										  
										  ?>
            <section class="inner-page-hero bg-image" data-image-src="images/img/dish.png">
                <div class="profile">
                    <div class="container">
                        <div class="row">
                            <div class="col-xs-12 col-sm-12  col-md-4 col-lg-4 profile-img">
                                <div class="image-wrap">
                                    <figure><?php echo '<img src="admin/Res_img/'.$rows['image'].'" alt="stores logo">'; ?></figure>
                                </div>
                            </div>
...
?>									
                                        ...
                                        <div class="title-row">
										<?php echo $item["title"]; ?><a href="item.php?s_id=<?php echo $_GET['s_id']; ?>&action=remove&id=<?php echo $item["d_id"]; ?>" >
...
?>								  
                                ...
                                <div class="widget-body">
                                    <div class="price-wrap text-xs-center">
                                        ...
                                        <p>Free Shipping</p>
                                        <a href="checkout.php?s_id=<?php echo $_GET['s_id'];?>&action=check"  class="btn theme-btn btn-lg">Checkout</a>
                                    </div>
                                </div>
                    ...
                    <div class="col-xs-12 col-sm-8 col-md-8 col-lg-6">
						...
						<?php  // display values and item of food/item
									$stmt = $db->prepare("select * from item where s_id='$_GET[s_id]'");
									$stmt->execute();
                                ...
                                <div class="food-item">
                                    <div class="row">
										...
										<form method="post" action='item.php?s_id=<?php echo $_GET['s_id'];?>&action=add&id=<?php echo $product['d_id']; ?>'>
                                            <div class="rest-logo pull-left">
                                                <a class="stores-logo pull-left" href="#"><?php echo '<img src="admin/Res_img/dishes/'.$product['img'].'" alt="Food logo">'; ?></a>
                                            </div>
                                            <!-- end:Logo -->
                        ...
                        <div class="row">
                            <div class="col-xs-12 col-sm-6 col-lg-6">
                                <div class="item-img pull-left">
                                    <a class="stores-logo pull-left" href="#"><img src="http://placehold.it/70x70" alt="Food logo"></a>
                                </div>
                                <!-- end:Logo -->
                                <div class="rest-descr">
