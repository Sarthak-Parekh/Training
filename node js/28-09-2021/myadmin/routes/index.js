...
var loginModel = require('../model/login_model.js');
/* GET home page. */
...
router.post('/signup',function(req,res,next){
  ...
  const signdata ={
    ...
    user_name : req.body.txt3
}
var sign = loginModel(signdata);
...
router.post('/login',function(req,res,next){
 ...
 console.log(req.body);
 loginModel.findOne({"user_email" : email },function(err,db_users_array){
...
router.post('/change-password', function (req, res, next) {
  ...
  loginModel.findOne({ "user_email": myemail }, function (err, db_users_array) {
      ...
      if (opass == db_users_array.user_password) {
        ...
        if (opass == npass) {
          ...
          if (npass == cpass) {
            ...
            loginModel.findOneAndUpdate({ "user_email": myemail }, {$set: {"user_password": npass}}, function (err) {
